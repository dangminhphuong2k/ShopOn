...
// 
//     Connection String Name: `ShopOnConnection`
//     Provider:               `System.Data.SqlClient`
//     Connection String:      `Data Source=laptop-gi04lq7l\sqlexpress;Initial Catalog=ShopOnline;Integrated Security=True`
//     Schema:                 ``
//     Include Views:          `False`
...
namespace ShopOnConnection
{
	public partial class ShopOnConnectionDB : Database
	{
		public ShopOnConnectionDB() 
			: base("ShopOnConnection")
		{
			CommonConstruct();
		}

		public ShopOnConnectionDB(string connectionStringName) 
		...
		{
			ShopOnConnectionDB GetInstance();
		}
		
		public static IFactory Factory { get; set; }
        public static ShopOnConnectionDB GetInstance()
        {
			if (_instance!=null)
				return _instance;
			...
			if (Factory!=null)
				...
				return new ShopOnConnectionDB();
        }

		[ThreadStatic] static ShopOnConnectionDB _instance;
		...
		{
			public static ShopOnConnectionDB repo { get { return ShopOnConnectionDB.GetInstance(); } }
	...
	[ExplicitColumns]
    public partial class LoaiSanPham : ShopOnConnectionDB.Record<LoaiSanPham>  
    {
	...
	[ExplicitColumns]
    public partial class NhaSanXuat : ShopOnConnectionDB.Record<NhaSanXuat>  
    {
	...
	[ExplicitColumns]
    public partial class SanPham : ShopOnConnectionDB.Record<SanPham>  
    {
	...
	[ExplicitColumns]
    public partial class sysdiagram : ShopOnConnectionDB.Record<sysdiagram>  
    {
